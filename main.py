...
def reset():
    ...
    lable.config(text='Timer',font=("Courier",33,'bold'),foreground="#9bdeac",background=YELLOW)
...
lable=Label(text="Timer",font=("Courier",33,'bold'),foreground="#9bdeac",background=YELLOW)
lable.grid(column=1,row=0)

canvas=Canvas(width=200,height=224,bg=YELLOW,highlightthickness=0)
img=PhotoImage(file="tomato.png")
canvas.create_image(102 , 112, image=img)
timer_text=canvas.create_text(103,130,text="00:00",font=("Courier",35,'bold'))
...
check=Label(background=YELLOW,foreground=GREEN)
